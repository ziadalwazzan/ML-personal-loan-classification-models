...
- **Input:** `data/Dataset - 2526.csv`
- **Output Notebook:** `notebooks/02_feature_engineering.ipynb`
- **Saved Artifacts:** `models/preprocess.pkl`
- **Reference:** `ML_Techniques_Summary.md` (encoding, scaling, SMOTE patterns)

## Constraints

- No model training (reserved for Phase 3)
- No resampling on test data
- Use `random_state=38` throughout
- Follow code style from `notebooks/01_data_exploration.ipynb`
